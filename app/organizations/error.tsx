  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f8fbff", padding: "24px", display: "grid", placeItems: "center" }}>
      <section style={{ width: "min(100%, 620px)", border: "1px solid #fecaca", background: "#fff7f7", borderRadius: 20, padding: 24, color: "#991b1b", boxShadow: "0 14px 36px rgba(15, 23, 42, 0.06)" }}>
        <p style={{ margin: 0, fontSize: 13, fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase" }}>{isUnauthorized ? "Session expired" : "Organizations error"}</p>
        <h1 style={{ margin: "8px 0 0", fontSize: 24, color: "#7f1d1d" }}>{isUnauthorized ? "Please login again" : "Organizations could not load"}</h1>
