  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f8fbff", padding: "24px" }}>
      <section style={{ border: "1px solid #dbeafe", background: "#ffffff", borderRadius: 20, padding: 24, boxShadow: "0 14px 36px rgba(15, 23, 42, 0.06)" }}>
        <p style={{ margin: 0, color: "#2563eb", fontSize: 13, fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase" }}>Organizations</p>
        <h1 style={{ margin: "8px 0 0", color: "#0f172a", fontSize: 26 }}>Loading organizations...</h1>
